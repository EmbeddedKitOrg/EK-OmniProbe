...
>(({ className, children, style, ...props }, ref) => {
  return (
    <DialogPortal>
      <DialogOverlay />
      <div className="fixed inset-0 z-[80] flex items-center justify-center p-4" style={{ pointerEvents: "none" }}>
        <DialogPrimitive.Content
          ref={ref}
          style={{ zIndex: 80, pointerEvents: "auto", ...style }}
          className={cn(
            "glass-dialog grid w-[min(calc(100vw-1rem),44rem)] max-h-[calc(100vh-1rem)] max-w-2xl gap-4 overflow-y-auto overscroll-contain rounded-[14px] p-5 text-foreground duration-200 focus:outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:p-5",
            className
          )}
          {...props}
        >
