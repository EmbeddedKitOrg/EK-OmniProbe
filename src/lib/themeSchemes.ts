...
export const THEME_SCHEMES: ThemeScheme[] = [
  ...
  },
  {
    ...
    vars: {
      ...
      "--ring": "185 50% 49%",
      "--accent": "183 55% 91%",
      "--accent-foreground": "187 33% 24%",
      "--secondary": "184 38% 94%",
      "--secondary-foreground": "188 25% 27%",
      "--border": "185 28% 81%",
      "--surface-2": "rgba(242, 252, 252, 0.94)",
      "--surface-3": "rgba(227, 246, 248, 0.96)",
      "--bg-spot-1": "rgba(115, 211, 216, 0.24)",
      "--bg-spot-2": "rgba(80, 160, 190, 0.16)",
      "--bg-gradient-top": "rgba(245, 253, 253, 0.98)",
      "--bg-gradient-bottom": "rgba(222, 241, 246, 0.98)",
      "--toolbar-chip-bg": "rgba(247, 255, 255, 0.86)",
      "--toolbar-chip-shadow": "0 6px 16px rgba(49, 142, 153, 0.14)",
      "--mode-glow-2": "rgba(128, 220, 219, 0.24)",
    },
  },
  {
    id: "forest",
